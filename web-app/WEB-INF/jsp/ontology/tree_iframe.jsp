...
<!DOCTYPE html>
<head>
    <link href="/skygen/common/style/rgd_styles-3.css" rel="stylesheet" type="text/css" >
    <link href="/skygen/css/ontology.css" rel="stylesheet" type="text/css" >
</head>
<body>
<%
    ...
    String url = "/skygen/ontology/view.html?mode=iframe&always_select=1";
